...
LilyGO T-Display-C5 是一款基于 **ESP32-C5** 的开发板，配备 1.9 英寸 ST7789 LCD 触摸屏、AXP2602 电源管理芯片和 CST816S 电容触摸控制器，支持按键（IO0）、I2C(IO2、IO3)深度睡眠唤醒。
...
>- ESP32C5在DeepSleep模式，IO0-IO6引脚可唤醒ESP32C5，详细说明请查看数据手册。
